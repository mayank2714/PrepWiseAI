...
const Home = () => {
  const { generateReport, reports } = useReports();
    ...
    <div className="home-page">
      ...
      <div className="interview-card">
        <div className="interview-card__body">
          ...
          <div className="panel panel--left panel-padding-left">
          ...
          {/* Right Panel - Profile */}
          <div className="panel panel--right panel-padding-right">
            <div className="panel__header">
              <span className="panel__icon">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="your-profile-heading">Your Profile</div>
            </div>
